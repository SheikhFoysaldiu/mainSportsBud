        ...
        <div className='mt-16 px-0 lg:px-20'>
            <div className='bg-white rounded-lg shadow-xl mx-0 lg:mx-20 pb-10'>
                ...
                <div className='my-4 mx-4'>
                    ...
                    <div>
                        <ul class="nav nav-tabs nav-justified lg:navbar-start flex flex-col md:flex-row flex-wrap list-none border-b-0 px-10 lg:px-0 mb-4" id="tabs-tab3"
                            role="tablist">
