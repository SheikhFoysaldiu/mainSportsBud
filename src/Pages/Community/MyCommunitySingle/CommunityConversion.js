...
import activePeople from '../../../Asset/Dummy/activeStatus.json';
    ...
    return (
        <div className="flex h-screen antialiased text-gray-800">
            <div className="flex flex-row h-full w-full overflow-x-hidden">
                <div className="hidden lg:flex lg:flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                    <div className="flex flex-row items-center justify-center h-12 w-full">
                        ...
                        <div className="ml-2 font-bold text-2xl">Group Chat</div>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <div className="text-xs text-gray-500">Football Lover</div>
                        <div className="mt-3">
                            <div className="leading-none ml-1 text-xs text-center">Active</div>
                        </div>
                    </div>
                    <div className="flex flex-col mt-8">
                        ...
                        <div className="flex flex-col space-y-1 mt-4 -mx-2 h-64 overflow-y-auto" id='scrollableDiv'>
                            <InfiniteScroll
                                ...
                                scrollableTarget="scrollableDiv">
                                {
                                    ...
                                    activeMembers.map(activeMember => <Link className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                                        <div className="avatar">
                                            <div className="w-8 rounded-full">
                                                <img src={activeMember.userImg} alt="active" />
                                            </div>
                                        </div>
                                        <div class="ml-2 text-sm font-semibold">{activeMember.userName}</div>
                                    </Link>)
                                }
                            </InfiniteScroll>
                        </div>
                    ...
                    >
                                    ...
                                    <div className="col-start-1 col-end-12 lg:col-end-8 p-3 rounded-lg">
                                        ...
                                        <div className="avatar">
                                            ...
                                            >
                                                <div className="flex flex-row items-center">
                                                    <button
                                                        className="flex items-center justify-center bg-indigo-600 hover:bg-indigo-800 rounded-full h-8 w-8 lg:w-10"
                                                    >
                                                        <svg
                                                    ...
                                                    <div className="flex flex-row items-center space-x-px ml-2 lg:ml-4">
                        ...
                        >
                            ...
                            <div className="ml-2 lg:ml-4">
                                <button
                                    className="flex items-center justify-center text-blue-600 flex-shrink-0"
                                >
                                    <span className="ml-2">
                                        <svg
...
export default CommunityConversion;