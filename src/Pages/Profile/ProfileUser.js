      ...
      <div className="h-full bg-white mt-16 lg:px-20">
        <div className="bg-white">
          ...
          <div className="w-full h-[250px] relative">
            {uploadImage && (
              <button className="absolute top-5 right-5" onClick={changeCover}>
                Save
              </button>
            )}
          ...
          <div className="flex flex-col items-center -mt-20 ">
            <div className="w-40 h-40 border-4 border-white rounded-full">
              <img
                ...
                alt="profile"
                className="w-38 h-38 border-4 border-white rounded-full object-contain"
              />
            </div>
