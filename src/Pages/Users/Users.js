                ...
                <div className="bg-white  ">
                    ...
                    <div className="flex flex-col items-center -mt-20">
                        <div className="w-40 h-40 border-4 border-white rounded-full">
                            <img src={data.user.profilePicture} alt="profile" className="w-38 h-38 border-4 border-white rounded-full object-contain" /></div>
                            ...
                            <div className="flex  items-center lg:items-center justify-center px-8 mt-2">
                                ...
                                <div className="flex items-center space-x-4 mt-2">
                                    <div className="flex items-center space-x-4 mt-2">
                                        ...
                                        <button className="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                                            <PersonRemove />
                                            <button disabled={loading} onClick={handleUnfriend}>Unfriend</button>
                                        </button>
                                    </div>
                                </div>
                            ...
                            wait ?
                                <div className="flex flex-col items-center lg:items-center justify-center px-8 mt-2">
                                    <div className="flex items-center space-x-4 mt-2">
                                        <button className="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                                            <Cancel />
                                            <button disabled={loading} onClick={handleCanelFriendRequest} >Cancel</button>
                                        </button>
                                    </div>
                                </div> :
                                ...
                                isFriendReceived ?
                                    <div className="flex flex-col items-center lg:items-center justify-center px-8 mt-2">
                                        <div className="flex items-center space-x-4 mt-2">
                                            <button className="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                                                <BsPersonCheckFill />
                                                <button disabled={loading} onClick={handleAcceptFriendRequest}>Accept</button>
                                            </button>
                                        </div>
                                    </div> :
                                    <div className="flex flex-col items-center lg:items-center justify-center px-8 mt-2">
                                        <div className="flex items-center space-x-4 mt-2">
                                            <button className="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                                                ...
                                                <button disabled={loading} onClick={handleSendFriendRequest}>Connect</button>
                                            </button>
                                        </div>
                                    </div>
