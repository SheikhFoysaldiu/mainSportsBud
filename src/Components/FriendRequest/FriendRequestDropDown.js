            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-700 p-1">
                <div className="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <div className="flex-shrink-0">
                        <img className="w-11 h-11 rounded-full" src={profile} alt="image" />
                    ...
                    <div className="pl-3 w-full">
                        <div className=''>
                            <Link to='/main/profileuser/1' className="font-semibold text-gray-800">{name}</Link>
        ...
        <div className="absolute flex flex-col z-20 top-[70px]   w-full max-w-sm bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-800 dark:divide-gray-700 right-[0] overflow-y-scroll h-[300px]">
            ...
            </div>
            {
                FriendRequests.length > 0 ? FriendRequests.map((item, index) => (
                    <FriendRequest key={index} item={item} />
                )) : <div className="text-center py-3">No Friend Request</div>
